...
class OrderDetails extends StatefulWidget {
  ...
  const OrderDetails({Key? key,
    required this.id, required this.id_com, required this.lat, required this.long, required this.client, required this.delai, required this.date_ajout, required this.distance, required this.prix, required this.client_id,
  })  : super(key: key);
